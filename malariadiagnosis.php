...
<a name="contact"></a>
	<div class="section_container third_section_container flex_container flex_center">
		...
		<tr>
		<td colspan = "2">	<center>Answer the following questions to the best of your knowledge</center> </td>
		</tr>
...
<tr>
		...
		</tr><tr><td colspan = "2"><center> <strong> <font face = "Bookman" color = "Red"> <br>RESULTS SUMMARY <br><br> <?php if(isset($_POST['chkname']))
		{
			...
			if($count<4)
			{
				echo "You do not have Malaria"."<br><br>"."RECOMMENDATION"."<br><br>"."Ensure you rest properly"."<br><br>"."If symtomps persists after 3 days, consult your doctor";
			}
			else if($count<7)
			{
				echo "You are showing signs of early Malaria"."<br><br>"."RECOMMENDATION"."<br><br>"."Ensure you rest properly; Purchase Malaria Anti-Parasite and Antibiotic drugs"."<br><br>"."Request for usage from your physician/pharmacist"."<br><br>"."If symtomps persists after 3 days, consult your doctor";
			}
			else
			{
					echo "You are showing signs of Malaria"."<br><br>"."RECOMMENDATION"."<br><br>"."Visit the hospital immediately"."<br><br>";
			}
		} ?> </center></font></td></tr>
